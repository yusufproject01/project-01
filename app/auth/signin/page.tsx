...
const SignInPage = () => {
    ...
    return (
        <main className="w-full h-screen flex justify-center items-center">
            <section className="w-80 h-auto flex flex-col justify-start items-center py-6 px-8 gap-4 bg-white shadow-lg rounded-lg shadow-primary">
                ...
                <form onSubmit={handleSignIn} className="w-full flex flex-col items-center gap-4">
                    ...
                    <button type="submit" className="w-64 h-8 text-base text-white bg-primary rounded-xl flex justify-center items-center hover:brightness-90">Login</button>
                </form>
